...
- **การเก็บรักษาที่เน้นฮาร์ดแวร์เป็นหลัก**: Bitcoin Safe ต้องใช้ [hardware signer]({{< ref "knowledge/supported-hardware-signers" >}}) เพื่อให้ seed อยู่บนอุปกรณ์เฉพาะทาง แทนที่จะกลายเป็นความลับแบบ hot บนคอมพิวเตอร์ทั่วไป
- **ขั้นตอนการตั้งค่าที่ปลอดภัยยิ่งขึ้น**: ตัวช่วยตั้งค่าช่วยให้ผู้ใช้สร้าง wallet ที่พร้อมใช้งานจริง โดยรวมถึงการทดสอบ [hardware signer]({{< ref "knowledge/supported-hardware-signers" >}}), [แผ่นสำรองข้อมูล PDF]({{< ref "features/pdf-export/" >}}), และคำแนะนำเกี่ยวกับการเก็บอุปกรณ์และ seed backup อย่างปลอดภัย
- **การยืนยันที่อยู่รับเงิน**: Bitcoin Safe ทำให้ [การยืนยันที่อยู่รับเงิน]({{< ref "knowledge/verify-receive-address/" >}}) บนอุปกรณ์ signer ก่อนแชร์ทำได้ง่าย
- **การตรวจจับ address poisoning**: แอปจะเตือนเมื่อพบ [ที่อยู่ที่น่าสงสัยและคล้ายกัน]({{< ref "features/address-poisoning/" >}})
...
- **การทำงานร่วมกันที่ทำให้ multisig ง่ายขึ้น**: Bitcoin Safe ทำให้ [การทำงานร่วมกันแบบ multisig]({{< ref "features/collaboration/" >}}) ใช้งานได้จริง จึงประสานการตั้งค่าและการเซ็นธุรกรรมได้ง่ายขึ้นมากในโลกจริง
