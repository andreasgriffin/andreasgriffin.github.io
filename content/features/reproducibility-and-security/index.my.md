...
- **Hardware-first custody**: Bitcoin Safe သည် [hardware signers]({{< ref "knowledge/supported-hardware-signers" >}}) ကိုလိုအပ်သောကြောင့် seed များသည် dedicated devices များပေါ်တွင်သာ နေပြီး general-purpose computer တစ်လုံးပေါ်ရှိ hot secrets မဖြစ်လာပါ။
- **ပိုမိုလုံခြုံသော setup flow**: Setup wizard သည် အသုံးပြုသူများကို အမှန်တကယ်အသုံးပြုရန် အသင့်ဖြစ်သော wallet များဖန်တီးနိုင်ရန် ကူညီပေးပြီး [hardware signer]({{< ref "knowledge/supported-hardware-signers" >}}) testing, [PDF backup sheets]({{< ref "features/pdf-export/" >}}), hardware signers နှင့် seed backups များကို မည်သို့သိမ်းဆည်းရမည်ဆိုသည့် guidance တို့ပါဝင်သည်။
- **Receive-address verification**: Bitcoin Safe သည် [receive addresses ကို verify လုပ်ခြင်း]({{< ref "knowledge/verify-receive-address/" >}}) ကို မျှဝေခင် signer ပေါ်မှာပဲ အလွယ်တကူလုပ်နိုင်စေသည်။
- **Address-poisoning detection**: သံသယဖြစ်ဖွယ် [look-alike addresses]({{< ref "features/address-poisoning/" >}}) များအကြောင်း သတိပေးသည်။
...
- **Collaboration that makes multisig easier**: Bitcoin Safe သည် [multisignature collaboration]({{< ref "features/collaboration/" >}}) ကို လက်တွေ့အသုံးဝင်စေသောကြောင့် setup နှင့် signing ကို ညှိနှိုင်းလုပ်ဆောင်ခြင်းသည် တကယ့်အသုံးပြုမှုတွင် ပိုမိုလွယ်ကူလာသည်။
