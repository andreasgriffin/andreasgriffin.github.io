...
- **Fast**
  ...
  - [Compact Block Filters](https://bitcoin-safe.org/en/library/compact-block-filters/) with [transaction notifications](https://bitcoin-safe.org/en/library/instant-transactions-notifications/)
- **Multi-Language**
...
- **Simpler** address labels by using categories (e.g. "KYC", "Non-KYC", "Work", "Friends", ...)
  ...
  - [Transaction flow diagrams](https://bitcoin-safe.org/en/library/money-flow-diagram/), visualizing inputs and outputs, click on inputs and output to trace the money flow
...
- **Plugin [Sync & Chat](https://bitcoin-safe.org/en/plugins/sync-chat/)**
  ...
  - [Label synchronization](https://bitcoin-safe.org/en/library/label-sync/) between different computers
  - [Wallet chat and PSBTs sharing](https://bitcoin-safe.org/en/plugins/sync-chat/) between different computers



### [Available on all platforms](https://bitcoin-safe.org/en/library/cross-platform/)
...
- **Import and Export Capabilities**
  ...
  - [Export of the money flow diagram](https://bitcoin-safe.org/en/library/money-flow-diagram/) to svg
...
- **Wallet Features**
  ...
  - [Backup PDF with Descriptor](https://bitcoin-safe.org/en/library/pdf-export/) (Text and QR code)
  - Message signing via USB and QR

- **Support for all major [hardware signers](https://bitcoin-safe.org/en/library/supported-hardware-signers/)**
  
  - [MicroSD (files)](https://bitcoin-safe.org/en/library/supported-hardware-signers/)
  - [USB](https://bitcoin-safe.org/en/library/supported-hardware-signers/)
  - [QR codes](https://bitcoin-safe.org/en/library/supported-hardware-signers/) (enhanced QR code detection for Laptop cameras)
  - [Animated QR codes](https://bitcoin-safe.org/en/library/supported-hardware-signers/) including [Coldcard/BBQr](https://bbqr.org/) and [UR](https://github.com/BlockchainCommons/Research/blob/master/papers/bcr-2020-005-ur.md) format

- **[Search and Filtering Options](https://bitcoin-safe.org/en/library/search/)**
  
  - [Fast filtering](https://bitcoin-safe.org/en/library/search/) across txids, utxos, labels, dates, amounts, categories
  - [Search across all open wallets](https://bitcoin-safe.org/en/library/search/), txids, utxos, labels, dates, amounts, categories

- **[Languages](https://bitcoin-safe.org/en/library/multi-language/)**
...
- **Transaction / PSBT Creation**
  ...
  - [Address poisoning detection and warning](https://bitcoin-safe.org/en/library/address-poisoning/)

- **Security and Reliability**
  
  - [No seed generation or storage on mainnet](https://bitcoin-safe.org/en/library/hardware-signer-only/)
  - [Seed storage requires a separate hardware signer](https://bitcoin-safe.org/en/library/hardware-signer-only/)  
  - [Update notifications](https://bitcoin-safe.org/en/library/instant-transactions-notifications/) and signature verification
  - Powered by [Bitcoin Development Kit (BDK)](https://github.com/bitcoindevkit/bdk)

- **Ease of Use for Multisig Wallets**
  
  - [Simplified setup](https://bitcoin-safe.org/en/library/setup-multisig-wallet/) for multisig wallets, including step-by-step instructions and [PDF backup sheet](https://bitcoin-safe.org/en/library/pdf-export/)
  - [Test signing](https://bitcoin-safe.org/en/library/setup-multisig-wallet/) with all hardware signers
  - [Collaborative wallet management](https://bitcoin-safe.org/en/library/collaboration/) including chat and PSBT sharing via nostr and label synchronization between trusted devices
  - Optional custom nostr server 

- **Fast syncing**: 
  - Electrum/Esplora server
  - [Compact Block Filters](https://bitcoin-safe.org/en/library/compact-block-filters/) 
