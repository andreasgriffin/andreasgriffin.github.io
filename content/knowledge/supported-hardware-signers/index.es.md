...
images: [ "logo.png" ]
keywords: ["monedero de hardware", "firmante de hardware"]
...
display_items:
  0-q:
    ...
    description: '
      ...
      <span class="bitcoin-only">Solo Bitcoin</span>
      '
  1-mk4:
  ...
  2-bitbox02:
    ...
    description: '
      <img src="/images/usb.svg"  class="coloredicon"  style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="USB logo">
      <span class="bitcoin-only-available">Disponible solo para Bitcoin</span><br>
      '
  3-passport:
    ...
    description: '
      <img src="/images/qr-code.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="QR logo">
      <img src="/images/sd-card.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="SD Card logo" >
      <span class="bitcoin-only">Solo Bitcoin</span><br>
      Obtén $10 de descuento con el código: <b>BITCOINSAFE</b>
      '
  4-jade:
    ...
    description: '
      ...
      <span class="bitcoin-only">Solo Bitcoin</span>
      <br> 
      Obtén un 10% de descuento con el código: <b>XEocg5boS77D</b>      
      '
  5-jadeplus:
  ...
  9-specter:
    ...
    description: '
      ...
      <img src="/images/sd-card.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="SD Card logo" >
      <span class="bitcoin-only">Solo Bitcoin</span><br> 
      Obtén un 5% de descuento con el código: <b>bitcoin-safe</b>      
      '
  91-seedsigner:
...
Una comparación completa de las características de los distintos firmantes de hardware está aquí: https://thebitcoinhole.com/hardware-wallets