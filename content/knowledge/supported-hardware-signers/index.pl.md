...
images: [ "logo.png" ]
keywords: ["portfel sprzętowy", "podpisywarka sprzętowa"]
...
display_items:
  0-q:
    ...
    description: '
      ...
      <span class="bitcoin-only">Tylko Bitcoin</span>
      '
  1-mk4:
  ...
  2-bitbox02:
    ...
    description: '
      <img src="/images/usb.svg"  class="coloredicon"  style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="USB logo">
      <span class="bitcoin-only-available">Dostępne: tylko Bitcoin</span><br>
      '
  3-passport:
    ...
    description: '
      <img src="/images/qr-code.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="QR logo">
      <img src="/images/sd-card.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="SD Card logo" >
      <span class="bitcoin-only">Tylko Bitcoin</span><br>
      Uzyskaj 10 USD zniżki z kodem: <b>BITCOINSAFE</b>
      '
  4-jade:
    ...
    description: '
      ...
      <span class="bitcoin-only">Tylko Bitcoin</span>
      <br> 
      Uzyskaj 10% zniżki z kodem: <b>XEocg5boS77D</b>      
      '
  5-jadeplus:
  ...
  9-specter:
    ...
    description: '
      ...
      <img src="/images/sd-card.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="SD Card logo" >
      <span class="bitcoin-only">Tylko Bitcoin</span><br> 
      Uzyskaj 5% zniżki z kodem: <b>bitcoin-safe</b>      
      '
  91-seedsigner:
...
Kompleksowe porównanie funkcji różnych podpisywarek sprzętowych znajduje się tutaj: https://thebitcoinhole.com/hardware-wallets