...
images: [ "logo.png" ]
keywords: ["ဟာ့ဒ်ဝဲ ဝေါလက်", "ဟာ့ဒ်ဝဲ လက်မှတ်ထိုးကိရိယာ"]
...
display_items:
  0-q:
    ...
    description: '
      ...
      <img src="/images/usb.svg"  class="coloredicon"  style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="USB အီကွန်">
      <img src="/images/qr-code.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="QR အီကွန်">
      <img src="/images/sd-card.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="SD ကတ် အီကွန်" >
      <span class="bitcoin-only">Bitcoin အတွက်သာ</span>
      '
  1-mk4:
  ...
  2-bitbox02:
    ...
    description: '
      <img src="/images/usb.svg"  class="coloredicon"  style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="USB အီကွန်">
      <span class="bitcoin-only-available">Bitcoin အတွက်သာ ရရှိနိုင်သည်</span><br>
      '
  3-passport:
    ...
    description: '
      <img src="/images/qr-code.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="QR အီကွန်">
      <img src="/images/sd-card.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="SD ကတ် အီကွန်" >
      <span class="bitcoin-only">Bitcoin အတွက်သာ</span><br>
      ကုဒ်ကို အသုံးပြု၍ $10 လျော့ဈေး ရယူနိုင်သည်: <b>BITCOINSAFE</b>
      '
  4-jade:
    ...
    description: '
      ...
      <span class="bitcoin-only">Bitcoin အတွက်သာ</span>
      <br> 
      ကုဒ်ကို အသုံးပြု၍ 10% အထိ လျော့ဈေးရယူနိုင်သည်: <b>XEocg5boS77D</b>      
      '
  5-jadeplus:
  ...
  9-specter:
    ...
    description: '
      ...
      <img src="/images/sd-card.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="SD ကတ် အီကွန်" >
      <span class="bitcoin-only">Bitcoin အတွက်သာ</span><br> 
      ကုဒ်ကို အသုံးပြု၍ 5% လျော့ဈေး ရယူနိုင်သည်: <b>bitcoin-safe</b>      
      '
  91-seedsigner:
...
ဟာ့ဒ်ဝဲ လက်မှတ်ထိုးကိရိယာ မျိုးစုံ၏ လုပ်ဆောင်ချက်များအား ပြည့်စုံစွာ နှိုင်းယှဉ်ထားသော စာမျက်နှာကို ဒီမှာ တွေ့နိုင်သည်: https://thebitcoinhole.com/hardware-wallets