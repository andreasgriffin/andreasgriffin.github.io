...
images: [ "logo.png" ]
keywords: ["محفظة أجهزة", "جهاز توقيع مادي"]
...
display_items:
  0-q:
    ...
    description: '
      ...
      <img src="/images/usb.svg"  class="coloredicon"  style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="شعار USB">
      <img src="/images/qr-code.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="شعار QR">
      <img src="/images/sd-card.svg"  class="coloredicon"   style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="شعار بطاقة SD" >
  ...
  2-bitbox02:
    ...
    description: '
      <img src="/images/usb.svg"  class="coloredicon"  style="height: 1.5em; margin-right: 1em; margin-bottom: 1em;" alt="شعار USB">
      <span class="bitcoin-only-available">يتوفر إصدار خاص بالبيتكوين</span><br>
      '
  3-passport:
    ...
    description: '
      ...
      احصل على خصم 10$ باستخدام الرمز: <b>BITCOINSAFE</b>
      '
  4-jade:
...
مقارنة شاملة لميزات أجهزة التوقيع المادية المختلفة موجودة هنا: https://thebitcoinhole.com/hardware-wallets